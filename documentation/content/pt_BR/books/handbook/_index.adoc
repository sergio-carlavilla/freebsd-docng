...
releaseinfo: "$FreeBSD: head/pt_BR.ISO8859-1/books/handbook/book.xml 53984 2020-03-15 16:03:31Z dbaio $" 
...
Bem vindo ao FreeBSD! Este manual cobre a instalação e o uso diário do _FreeBSD 12.1-RELEASE_ e do _FreeBSD 11.3-RELEASE_. Este livro é o resultado do trabalho contínuo de muitas pessoas. Algumas seções podem estar desatualizadas. Os interessados em ajudar a atualizar e expandir este documento devem enviar e-mails para a http://lists.FreeBSD.org/mailman/listinfo/freebsd-doc[lista de discussão do projeto de documentação do FreeBSD].
...
include::content/pt_BR/books/handbook/toc.adoc[]

include::content/pt_BR/books/handbook/toc-figures.adoc[]

include::content/pt_BR/books/handbook/toc-tables.adoc[]

include::content/pt_BR/books/handbook/toc-examples.adoc[]
