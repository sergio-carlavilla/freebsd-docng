...
image::bsdinstall/bsdinstall-newboot-loader-menu.png[]
...
image::bsdinstall/bsdinstall-boot-options-menu.png[]
...
image::bsdinstall/bsdinstall-keymap-loading.png[]
...
image::bsdinstall/bsdinstall-keymap-10.png[]
...
image::bsdinstall/bsdinstall-keymap-testing.png[]
...
image::bsdinstall/bsdinstall-zfs-partmenu.png[]
...
.Confirmação
image::bsdinstall/bsdinstall-ufs-warning.png[]
...
image::bsdinstall/bsdinstall-zfs-menu.png[]
...
.Tipo de pool ZFS
image::bsdinstall/bsdinstall-zfs-vdev_type.png[]
...
.Seleção de disco
image::bsdinstall/bsdinstall-zfs-disk_select.png[]

[[bsdinstall-zfs-vdev_invalid]]
.Seleção inválida
image::bsdinstall/bsdinstall-zfs-vdev_invalid.png[]
...
image::bsdinstall/bsdinstall-zfs-rescan-devices.png[]
...
.Analisando um disco
image::bsdinstall/bsdinstall-zfs-disk_info.png[]
...
.Nome do Pool
image::bsdinstall/bsdinstall-zfs-pool-name.png[]
...
.Quantidade de Swap
image::bsdinstall/bsdinstall-zfs-swap-amount.png[]
...
.Última chance
image::bsdinstall/bsdinstall-zfs-warning.png[]
...
image::bsdinstall/bsdinstall-zfs-geli_password.png[]

[[bsdinstall-zfs-init-encription]]
.inicializando Criptografia
image::bsdinstall/bsdinstall-zfs-init-encription.png[]
...
.Definindo a Senha de `root`
image::bsdinstall/bsdinstall-post-root-passwd.png[]
...
.Selecionar Data
image::bsdinstall/bsdinstall-timezone-date.png[]
...
.Selecionar Hora
image::bsdinstall/bsdinstall-timezone-time.png[]
...
image::bsdinstall/bsdinstall-hardening.png[]
...
image::bsdinstall/bsdinstall-configure-wireless-scan.png[]
...
.Configuração WPA2
image::bsdinstall/bsdinstall-configure-wireless-wpa2setup.png[]
...
.Escolha a rede IPv4
image::bsdinstall/bsdinstall-configure-network-interface-ipv4.png[]
...
image::bsdinstall/bsdinstall-configure-network-interface-ipv4-dhcp.png[]
...
image::bsdinstall/bsdinstall-configure-network-interface-ipv4-static.png[]
...
[[bsdinstall-net-ipv6]]
.Escolha a rede IPv6
image::bsdinstall/bsdinstall-configure-network-interface-ipv6.png[]
...
image::bsdinstall/bsdinstall-configure-network-interface-slaac.png[]
...
image::bsdinstall/bsdinstall-configure-network-interface-ipv6-static.png[]
...
.Configuração do DNS
image::bsdinstall/bsdinstall-configure-network-ipv4-dns.png[]
...
image::bsdinstall/bsdinstall-netinstall-mirrorselect.png[]
