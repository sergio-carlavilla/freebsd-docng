...
Este comando cria o `tank/poudriere/ports/default`, monta-o em [.filename]#/poudriere/ports/default# e o povoa usando o man:portsnap[8]. Depois disso, ele é incluído na lista de árvores de ports conhecidas:
...
Cria `tank/poudriere/ports/subversive` e o monta em [.filename]#/poudriere/ports/subversive#. Em seguida, ele é povoado usando Subversion. Finalmente, ele é adicionado à lista de árvores de ports conhecidas:
