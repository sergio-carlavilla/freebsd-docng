...
Verwenden Sie [.filename]#kernel.GENERIC#, um den allgemeinen Kernel zu bezeichnen, der vorinstalliert wird. [.filename]#kernel.old# bezeichnet den Kernel, der vor dem System-Upgrade installiert war.
