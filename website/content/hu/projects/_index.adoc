...
Emellett néhány itt szereplõ projekt rendszeresen nyilvánosságra hoz helyzetjelentéseket, amelyek megtekinthetõek a link:https://www.FreeBSD.org/news/status/[helyzetjelentések] oldalán.
