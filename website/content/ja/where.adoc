...
a|
* link:../releases/#current[リリース]: {rel113-current-date}
* link:{u-rel113-notes}[リリースノート]
* link:{u-rel113-readme}[Readme]
* link:{u-rel113-hardware}[ハードウェア互換リスト]
* link:{u-rel113-installation}[インストールガイド]
* link:{u-rel113-errata}[Errata]
* link:{u-rel113-signatures}[署名済チェックサム]
...
//* link:../relnotes/{rel121-current-major}-STABLE/relnotes/article[リリースノート]
