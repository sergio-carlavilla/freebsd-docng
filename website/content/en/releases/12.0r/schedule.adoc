...
General discussions about the pending release and known issues should be sent to the public mailto:FreeBSD-current@FreeBSD.org[freebsd-current] mailing list. link:{handbook}#mfc-glossary[MFC] requests are no longer being accepted for {{% param localBranchReleng %}}.
